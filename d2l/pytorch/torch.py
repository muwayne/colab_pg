...
def masked_softmax(X, valid_lens):
    """Perform softmax operation by masking elements on the last axis.
        X is a 3D tensor in format (batch_size, num_pairs, num_inputs)
        valid_lens is a 1D tensor in format (batch_size,) or a 2D tensor in format (batch_size, num_pairs)
